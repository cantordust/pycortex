...
def init_conf():
    ...
    parser.add_argument('--no-speciation', help='Disable speciation')
    ...
    parser.add_argument('--download-data', help='Indicate whether the training data should be downloaded automatically.')
